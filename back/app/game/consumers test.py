...
class PrivateGameConsumer(AsyncWebsocketConsumer):
    """
    Consumer WebSocket para un game privado entre dos usuarios.
    """
    async def connect(self):
        """
        Se ejecuta cuando un usuario se conecta.
        - Se obtiene el nombre único de la sala a partir de los dos usuarios en el game.
        ...
        self.room_name = f'game_{min(self.user1, self.user2)}_{max(self.user1, self.user2)}'
    ...
    async def disconnect(self, close_code):
        ...
        - Se elimina del grupo de game en Redis.
        """
    ...
    async def receive(self, text_data):
        ...
        # Enviar el mensaje a la otra persona en el game
